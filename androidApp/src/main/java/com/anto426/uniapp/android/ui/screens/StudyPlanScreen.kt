...
import com.anto426.uniapp.android.ui.components.items.StudyCourseItem
...
fun StudyPlanScreen(
    ...
    UniScreenColumn {
        ...
        LiquidSectionTitle(
            ...
            subtitle = stringResource(R.string.ui_exams_planned, currentYear.courses.size.toString())
        )
