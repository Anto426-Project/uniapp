...
fun AppInfoScreen(
    ...
    UniScreenColumn {
        ...
        LiquidPreferenceGroup(title = stringResource(R.string.ui_project_summary_title), backdropState = backdropState) {
            Text(
                text = stringResource(R.string.ui_project_summary_text),
        ...
        LiquidPreferenceGroup(title = stringResource(R.string.ui_app_info_group), backdropState = backdropState) {
            LiquidPreferenceItem(
                title = stringResource(R.string.ui_source),
                subtitle = stringResource(R.string.ui_source_subtitle),
            ...
            LiquidPreferenceItem(
                title = stringResource(R.string.ui_author),
                subtitle = stringResource(R.string.ui_author_subtitle),
        ...
        LiquidPreferenceGroup(title = stringResource(R.string.ui_legal_notes), backdropState = backdropState) {
            LiquidPreferenceItem(
                title = stringResource(R.string.ui_privacy),
            ...
            LiquidHorizontalDivider(modifier = Modifier.padding(horizontal = 12.dp))
            LiquidPreferenceItem(
                title = stringResource(R.string.ui_terms),
            ...
            LiquidHorizontalDivider(modifier = Modifier.padding(horizontal = 12.dp))
            LiquidPreferenceItem(
                title = stringResource(R.string.ui_cookies),
