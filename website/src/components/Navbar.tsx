    ...
    <header className={`site-header ${scrolled ? 'scrolled' : ''}`}>
      ...
      >
        ...
        <div className="nav-links">
          <a href="#screenshots" className="nav-link">Schermate</a>
          <a href="#features" className="nav-link">Caratteristiche</a>
          <a href="#architecture" className="nav-link">Architettura</a>
